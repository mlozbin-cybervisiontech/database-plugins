...
import io.cdap.dbcommons.ConnectionConfig;
import io.cdap.dbcommons.DBConfig;
import io.cdap.dbcommons.db.batch.source.AbstractDBSource;
...
public class AuroraPostgresSourceTestRun extends AuroraPostgresPluginTestBase {
  ...
  public void testUserNamePasswordCombinations() throws Exception {
    ...
    // as source
    ETLPlugin dbConfig = new ETLPlugin(AuroraPostgresConstants.PLUGIN_NAME, BatchSource.PLUGIN_TYPE,
    ...
    database = new ETLStage("databaseSource", new ETLPlugin(AuroraPostgresConstants.PLUGIN_NAME,
