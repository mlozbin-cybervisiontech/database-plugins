...
import io.cdap.plugin.jdbc.db.batch.action.DBActionTestRun;
import io.cdap.plugin.jdbc.db.batch.action.DBQueryActionTestRun;
import io.cdap.plugin.jdbc.db.batch.sink.DBSinkTestRun;
import io.cdap.plugin.jdbc.db.batch.sink.DBSourceTestRun;
