...
package io.cdap.plugin.jdbc.db.batch.action;
...
import io.cdap.dbcommons.db.batch.action.QueryActionConfig;
import io.cdap.dbcommons.db.batch.action.QueryConfig;
import io.cdap.plugin.common.batch.action.Condition;
import io.cdap.plugin.jdbc.DatabaseConstants;
import io.cdap.plugin.jdbc.GenericDatabasePluginTestBase;
